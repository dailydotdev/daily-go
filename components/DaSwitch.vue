<template>
  <label class="switch">
    ...
    <input type="checkbox" :checked="checked" @change="onChange" ref="input">
    <span class="slider"></span>
    <span class="handle horizontal align-center justify-center" ref="handle">
      <svgicon :name="icon" v-if="icon"></svgicon>
    </span>
    </span>
    <span class="label title" v-if="label">{{label}}</span>
  </label>
</template>
