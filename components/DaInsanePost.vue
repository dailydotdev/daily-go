<template>
  <div class="insane-row" :class="cls">
    <div class="content flex">
      <a :href="link" target="_blank" class="caption primary" @click="onClick">{{ title | cardTitle }}</a>
    ...
    <div class="actions vertical align-center justify-center">
      <button class="bookmark vertical" @click.prevent="onBookmark">
